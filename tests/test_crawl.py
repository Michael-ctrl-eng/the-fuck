...
class TestCrawl:
    ...
    async def test_start_crawl_job(self, client, auth_headers, test_tenant):
    ...
    async def test_list_crawl_jobs(self, client, auth_headers, test_tenant):
        # Create a job first
        await client.post(
            f"/api/tenants/{test_tenant.id}/crawl",
    ...
    async def test_get_crawl_job_detail(self, client, auth_headers, test_tenant):
        # Create a job
